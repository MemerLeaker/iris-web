...
from app.blueprints.rest.v2.case_objects.recommendations import case_recommendations_blueprint
...
cases_blueprint.register_blueprint(case_recommendations_blueprint)
